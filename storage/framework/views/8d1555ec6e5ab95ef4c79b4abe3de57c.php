...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="actions">
      <button id="btn-apply" class="btn btn-primary">Aplicar</button>
      <button id="btn-reset" class="btn btn-outline">Limpiar</button>
    </div>
    </div>
...
<?php /**PATH D:\Proyectos\Barrio-Limpio\resources\views/dashboard/official_reports.blade.php ENDPATH**/ ?>