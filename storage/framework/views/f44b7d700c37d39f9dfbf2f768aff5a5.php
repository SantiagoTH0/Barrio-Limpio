...
<head>
  ...
  <title>Detalle del reporte #<?php echo e($report->id); ?> - Barrio Limpio</title>
...
<div class="container">
  <nav class="breadcrumbs">
    ...
    <span>Detalle #<?php echo e($report->id); ?></span>
  </nav>
  <header>
    <div>
      <h1>Detalle del reporte #<?php echo e($report->id); ?></h1>
      <div class="muted">Creado: <?php echo e($report->created_at ? $report->created_at->format('d/m/Y H:i') : '—'); ?></div>
    </div>
    <div>
      <a class="btn btn-primary" href="/dashboard/official/reports">Volver</a>
    </div>
  </header>
  ...
  <div class="grid">
    <div class="card">
      <div class="meta"><div class="label">Estado</div><div class="value">
        ...
        ?>
        <span class="status-badge <?php echo e($m['cls']); ?>"><?php echo e($m['label']); ?></span>
      </div></div>
      <div class="meta"><div class="label">Tipo</div><div class="value"><?php echo e($report->type?->name ?? '—'); ?></div></div>
      <div class="meta"><div class="label">Zona</div><div class="value"><?php echo e($report->zone ?? '—'); ?></div></div>
      <div class="meta"><div class="label">Ubicación</div><div class="value"><?php echo e($report->location_text ?? '—'); ?></div></div>
      <div class="meta"><div class="label">Creado por</div><div class="value"><?php echo e($report->user?->name); ?> (<?php echo e($report->user?->email); ?>)</div></div>
      <div class="meta"><div class="label">Cuadrilla</div><div class="value"><?php echo e($report->crew?->name ?? '—'); ?></div></div>
      <div class="meta"><div class="label">Asignado a</div><div class="value"><?php echo e($report->assignedUser?->name ?? '—'); ?></div></div>
      <div class="meta"><div class="label">Iniciado</div><div class="value"><?php echo e($report->started_at ? $report->started_at->format('d/m/Y H:i') : '—'); ?></div></div>
      <div class="meta"><div class="label">Resuelto</div><div class="value"><?php echo e($report->resolved_at ? $report->resolved_at->format('d/m/Y H:i') : '—'); ?></div></div>
    </div>
    <div class="card">
      <h3>Fotografía</h3>
      <div class="photo">
        <?php if($report->photo_url): ?>
          <img src="<?php echo e($report->photo_url); ?>" alt="Foto reporte #<?php echo e($report->id); ?>">
        <?php else: ?>
  ...
  <div class="card section">
    <h3>Descripción</h3>
    <p style="white-space:pre-wrap"><?php echo e($report->description ?? 'Sin descripción.'); ?></p>
  </div>
</div>
<?php echo $__env->make('dashboard.partials.jivochat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
<?php /**PATH D:\Proyectos\Barrio-Limpio\resources\views/dashboard/official_report_detail.blade.php ENDPATH**/ ?>