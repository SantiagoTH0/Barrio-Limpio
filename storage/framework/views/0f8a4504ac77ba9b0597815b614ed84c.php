      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $crew_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td>
              <a class="button" href="/dashboard/official/collaborators/<?php echo e($u->id); ?>/tasks">Ver tareas</a>
            </td>
          </tr>
...
</html><?php /**PATH D:\Proyectos\Barrio-Limpio\resources\views/dashboard/official_collaborators.blade.php ENDPATH**/ ?>