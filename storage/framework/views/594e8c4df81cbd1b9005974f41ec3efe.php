  ...
  <div class="grid-2">
    <div class="card">
      ...
      <table>
        ...
        <tbody>
          <?php $__currentLoopData = ($top_types ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <div class="card">
      ...
      <table>
        ...
        <tbody>
          <?php $__currentLoopData = ($top_zones ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($z['zone']); ?></td>
              <td><?php echo e($z['total']); ?></td>
            </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
</html><?php /**PATH D:\Proyectos\Barrio-Limpio\resources\views/dashboard/official.blade.php ENDPATH**/ ?>