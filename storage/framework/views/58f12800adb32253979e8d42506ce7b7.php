...
<div class="container">
  <nav class="breadcrumbs">
    ...
    <span>Tareas de <?php echo e($collaborator->name); ?></span>
  </nav>

  <header>
    <div>
      <h1>Tareas asignadas a <?php echo e($collaborator->name); ?></h1>
      <div class="muted"><?php echo e($collaborator->email); ?> — Rol: colaborador</div>
    </div>
    <div>
  ...
  <div class="card" style="margin-top:16px">
    ...
    <table>
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            <td><?php echo e($r->id); ?></td>
            <td><?php echo e($r->type?->name ?? '—'); ?></td>
            <td>
              <?php ($status = $r->status); ?>
              <?php if($status === \App\Models\Report::STATUS_RESOLVED): ?>
                <span class="status-badge status-green">Resuelto</span>
              <?php elseif($status === \App\Models\Report::STATUS_IN_PROGRESS): ?>
...
</html><?php /**PATH D:\Proyectos\Barrio-Limpio\resources\views/dashboard/official_collaborator_tasks.blade.php ENDPATH**/ ?>